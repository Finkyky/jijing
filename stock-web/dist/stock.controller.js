...
let StockController = class StockController {
    constructor(stockService, aiAnalysisService) {
    ...
    getAnalysisDetailPage(id, res) {
        const analysis = this.aiAnalysisService.getAnalysis(id);
        if (!analysis) {
            throw new common_1.NotFoundException('分析报告不存在');
        }
    ...
    loadDataByDate(date) {
        ...
        if (!success) {
            throw new common_1.NotFoundException(`未找到 ${date} 的数据`);
        }
        return {
            success: true,
    ...
    getSummary(company, minCap, maxCap, industry, keyword) {
    ...
    getStock(code) {
        ...
        if (!result) {
            throw new common_1.NotFoundException('股票不存在');
        }
        return result;
    }
    getStatistics() {
    ...
    exportExcel(res, date) {
        ...
        try {
            ...
            res.setHeader('Content-Disposition', `attachment; filename=stock_filter_${timestamp}.xlsx`);
            res.send(buffer);
        }
        catch (error) {
            throw new common_1.NotFoundException('导出失败：暂无数据');
        }
    }
    refreshData() {
    ...
    async createAnalysis(code) {
        const stockData = this.stockService.getStockByCode(code);
        if (!stockData || !stockData.summary) {
            throw new common_1.NotFoundException('股票不存在');
        }
        const analysis = await this.aiAnalysisService.createAnalysis(code, stockData.summary.股票名称, {
    ...
    getAnalysesByStock(code) {
        return this.aiAnalysisService.getAnalysesByStock(code);
    }
    downloadAnalysis(id, format, res) {
        const analysis = this.aiAnalysisService.getAnalysis(id);
        if (!analysis || !analysis.analysis) {
            throw new common_1.NotFoundException('分析报告不存在或未完成');
        }
        let content;
        let filename;
        let contentType;
...
<body>
                ...
                <div class="analyses-grid">
                    ...
                    <div class="analysis-card" onclick="window.location.href='/analysis/${a.id}'">
                        <div class="analysis-card-header">
                            ...
                            <span class="analysis-card-status status-${a.status}">${a.status === 'completed' ? '已完成' : a.status === 'pending' ? '分析中' : '失败'}</span>
                        </div>
    ...
    generateAnalysisDetailPage(analysis) {
        ...
        <div class="analysis-detail">
            ...
            <div class="detail-card">
                ...
                <ul class="highlight-list">
                    ${a.investmentHighlights.map((h) => `<li>${h}</li>`).join('')}
                </ul>
            </div>
            ...
            <div class="detail-card">
                ...
                <ul class="risk-list">
                    ${a.riskWarnings.map((r) => `<li>${r}</li>`).join('')}
                </ul>
            </div>
...
], StockController.prototype, "getHomePage", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getAnalysesPage", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StockController.prototype, "getAnalysisDetailPage", null);
__decorate([
    (0, common_1.Get)('api/dates'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getAvailableDates", null);
__decorate([
    (0, common_1.Get)('api/date/:date'),
    __param(0, (0, common_1.Param)('date')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "loadDataByDate", null);
__decorate([
    (0, common_1.Get)('api/current-date'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getCurrentDate", null);
__decorate([
    (0, common_1.Get)('api/update-time'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getUpdateTime", null);
__decorate([
    (0, common_1.Get)('api/summary'),
    __param(0, (0, common_1.Query)('company')),
    __param(1, (0, common_1.Query)('minCap')),
    __param(2, (0, common_1.Query)('maxCap')),
...
__decorate([
    (0, common_1.Get)('api/detail'),
    __param(0, (0, common_1.Query)('code')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getDetail", null);
__decorate([
    (0, common_1.Get)('api/stock/:code'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getStock", null);
__decorate([
    (0, common_1.Get)('api/statistics'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getStatistics", null);
__decorate([
    (0, common_1.Get)('api/companies'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getCompanies", null);
__decorate([
    (0, common_1.Get)('api/industries'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getIndustries", null);
__decorate([
    (0, common_1.Get)('api/export'),
    __param(0, (0, common_1.Res)()),
    __param(1, (0, common_1.Query)('date')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "exportExcel", null);
__decorate([
    (0, common_1.Get)('api/refresh'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "refreshData", null);
__decorate([
    (0, common_1.Post)('api/analyze/:code'),
    __param(0, (0, common_1.Param)('code')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StockController.prototype, "createAnalysis", null);
__decorate([
    (0, common_1.Get)('api/analysis/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getAnalysis", null);
__decorate([
    (0, common_1.Get)('api/analyses'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getAllAnalyses", null);
__decorate([
    (0, common_1.Get)('api/analyses/:code'),
    __param(0, (0, common_1.Param)('code')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "getAnalysesByStock", null);
__decorate([
    (0, common_1.Get)('api/analysis/:id/download'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], StockController.prototype, "downloadAnalysis", null);
